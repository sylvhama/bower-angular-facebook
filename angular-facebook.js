        ...
        return {
            ...
            getInvitableFriends: function() {
                FB.api(
                    ...
                    function (response) {
                        return $rootScope.$broadcast("fb_invitableFriends", response);
                    }
                );
            },
            ...
            getAppRequests: function() {
                FB.api(
                    "/me/apprequests",
                    function (response) {
                        return $rootScope.$broadcast("fb_appRequests", response);
                    }
                );
            },
            ...
            appRequest: function(message, id) {
                FB.ui({method: 'apprequests',
                    message: message,
                    to: id
                }, function(response){
                    return $rootScope.$broadcast("fb_appRequest", response);
                });
            },
